...
#'
#' @export
bb_text <- function(label, x, y, just = "center", rotation = 0, units = "inches", fontcolor = "black", transparency = 1, fontsize = 12, cex = 1,
  ...
  grid.text(label = label, x = unit(new_x, page_units), y = unit(page_height - new_y, page_units), just = just, rot = rotation,
