...
#'
#' @usage
#' bb_plotSegments(x0, y0, x1, y1, default.units = "inches")
#'
...
#'
#' @export
bb_plotSegments <- function(x0, y0, x1, y1, default.units = "inches", linecolor = "black", alpha = 1, lwd = 1, lty = 1, lineend = "butt", linejoin = "mitre", arrow = NULL, params = NULL, ...){
  ...
  bb_segments <- structure(list(x0 = bb_segmentsInternal$x0, y0 = bb_segmentsInternal$y0, x1 = bb_segmentsInternal$x1, y1 = bb_segmentsInternal$y1,
                                ...
                                gp = gpar(col = bb_segmentsInternal$linecolor, lwd = bb_segmentsInternal$lwd,lty = bb_segmentsInternal$lty, lineend = bb_segmentsInternal$lineend,
                                          linejoin = bb_segmentsInternal$linejoin, alpha = bb_segmentsInternal$alpha, ...)), class = "bb_segments")
