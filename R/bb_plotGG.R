...
#'
#' ## Add title
#' bb_plotText(label = "mtcars", fontsize = 14, fontface = "bold",
#'             x = 1, y = 0.35)
#'
#' ## Hide page guides
#' bb_pageGuideHide()
...
bb_plotGG <- function(plot, x, y, width, height, just = c("left", "top"),
  ...
  bb_ggInternal <- structure(list(plot = plot, x = x, y = y, width = width,
                                  height = height, just = just,
                                  default.units = default.units),
                             class = "bb_ggInternal")

  bb_ggInternal <- parseParams(bb_params = params,
                               object_params = bb_ggInternal)
  ...
  gg_plot <- structure(list(width = bb_ggInternal$width,
  ...
  gg_plot <- defaultUnits(object = gg_plot,
  ...
  vp_name <- paste0("bb_gg",
                    length(grep(pattern = "bb_gg",
