...
#' 
#' @export
bbMapColors <- function(vector, palette, range = NULL){
...
## Color palette and range default assignments for bbMapColors
...
bb_parseColors <- function(data, fill, object, subset = NULL){
    ...
    if (is(fill, "bb_colorby")){
        ...
        ## Pass into bbMapColors
        colors <- bbMapColors(vector = colorbyCol,
