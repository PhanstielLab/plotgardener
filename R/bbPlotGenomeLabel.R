...
#' bbPageCreate(width = 5, height = 3, default.units = "inches")
#'
...
#' bbPageGuideHide()
#' @export
bbPlotGenomeLabel <- function(chrom, chromstart = NULL, chromend = NULL,
    ...
    ## Define a function that catches errors for bbPlotGenomeLabel
    ...
    if (base::length(bb_genomeLabel$chrom) == 1){
        ...
        vp_name <- bbPlotChromGenomeLabel(bb_genomeLabel = bb_genomeLabel,
    ...
    # =========================================================================
        vp_name <- bbPlotManhattanGenomeLabel(bb_genomeLabel = bb_genomeLabel,
                                bb_genomeLabelInternal = bb_genomeLabelInternal)
...
# @param bb_genomeLabel bb_genomeLabel object from bbPlotGenomeLabel
# @param bb_genomeLabelInternal bb_genomeLabelInternal object 
# from bbPlotGenomeLabel
bbPlotChromGenomeLabel <- function(bb_genomeLabel, 
...
# @param bb_genomeLabelInternal bb_genomeLabelInternal object 
# from bbPlotGenomeLabel
bbPlotManhattanGenomeLabel <- function(bb_genomeLabel, bb_genomeLabelInternal){
