...
#'
#' @export
bbPlotSignal <- function(data, binSize = NA, binCap = TRUE, negData = FALSE,
    ...
    ## Define a function that catches errors for bbPlotSignal
    ...
    ## Define a function that reads in signal data for bbPlotSignal
    ...
    ## Justification
    bb_sigInternal$just <- bb_justConversion(just = bb_sigInternal$just)
