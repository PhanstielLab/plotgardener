...
#' 
#' @export
bbPlotIdeogram <- function(chrom, assembly = "hg38", data = NULL,
    ...
    ## Define a function that checks errors for bbPlotIdeogram
    ...
    attr(x = ideogramPlot, which = "plotted") <- bb_ideoInternal$draw
    ...
    ideogramPlot$assembly <-
        parse_bbAssembly(assembly = ideogramPlot$assembly)
    ...
    ideogramPlot$grobs <- get("ideogram_grobs", envir = bbEnv)
