...
#' bbPageCreate(width = 7.5, height = 2.5, default.units = "inches")
#'
...
#' @export
bbAnnoSegments <- function(x0, y0, x1, y1, plot, default.units = "native",
    ...
    ## Get page_height and its units from bbEnv through bbPageCreate
    ...
    plotVP <- getAnnoViewport(plot = bb_segmentsInternal$plot)
