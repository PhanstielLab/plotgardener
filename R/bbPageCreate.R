...
#' bbPageCreate(width = 6, height = 4.5, default.units = "inches")
#'
#' ## Create a 14-cm wide, 10-cm high Bentobox page
#' bbPageCreate(width = 14, height = 10, default.units = "cm")
#' @details \code{width} and \code{height} must be specified in the same units.
#'
#' @return None.
#'
#' @export
bbPageCreate <- function(width = 8.5, height = 11, default.units = "inches",
    ...
    tryCatch(expr = {
        xGrid <- segmentsGrob(
            x0 = seq(0, page_width, bb_page$xgrid),
            y0 = 0,
