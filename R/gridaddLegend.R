...
gridaddLegend <- function(color_vector, min_label, max_label, height, width, x, y, location = "right", fontsize = 8, fontcolor = "grey",...){
  # Convert user-inputted coordinates
  legend_coordinates <- convert_coordinates(height, width, x, y)
