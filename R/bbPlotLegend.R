...
#' bbPageCreate(width = 7.5, height = 4, default.units = "inches")
#'
...
#' bbPageGuideHide()
#' @export
bbPlotLegend <- function(legend, fill = NULL, pch = NULL, lty = NULL,
    ...
    ## Justification
    bb_legInternal$just <- bb_justConversion(just = bb_legInternal$just)
    ...
    attr(x = legendPlot, which = "plotted") <- bb_legInternal$draw
    ...
    legendPlot$grobs <- get("legend_grobs", envir = bbEnv)
