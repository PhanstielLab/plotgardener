...
#' \preformatted{
#' bbPlotTranscripts(chrom, chromstart = NULL, chromend = NULL,
...
#'
#' @export
bbPlotTranscripts <- function(chrom, chromstart = NULL, chromend = NULL,
                            assembly = "hg38",
                            fill = c("#669fd9", "#abcc8e"),
    ...
    ## Define a function that checks errors for bbPlotTranscripts
    errorcheck_bbPlotTranscripts <- function(transcriptPlot, labels, fill) {

        ## Genomic region
        bb_regionErrors(chromstart = transcriptPlot$chromstart,
    ...
    errorcheck_bbPlotTranscripts(
        transcriptPlot = bb_transcripts,
