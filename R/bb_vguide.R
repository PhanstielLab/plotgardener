...
#'
#' @param x x-coordinate to draw guide
#' @param units units of x-coordinate
#' @param col color of guideline

#' @export
bb_vGuide <- function(x, units = "inches", col = "grey55"){
  ...
  guide <- grid.segments(x0 = x, x1 = x, y0 = unit(0, units = "npc"), y1 = unit(1, units = "npc"), default.units = units,
                           gp = gpar(col = col))
