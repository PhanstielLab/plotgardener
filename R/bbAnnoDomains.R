...
#' bbPageGuideHide()
#' @export
bbAnnoDomains <- function(plot, data, half = "inherit",
    ...
    ## Define a function that checks errors for bbAnnoDomains
    errorcheck_bbAnnoDomains <- function(hic, half) {
