...
getPackages <- function(genome, TxDb=NULL){
  switch(genome,
         "bosTau8" = structure(list("TxDb" = ifelse(is.null(TxDb), "TxDb.Btaurus.UCSC.bosTau8.refGene", TxDb),
                          "OrgDb" = "org.Bt.eg.db", gene.id.column = "ENTREZID", display.column = "SYMBOL",
                          "BSgenome" = "BSgenome.Btaurus.UCSC.bosTau8"), class = "bb_assembly"),
         "bosTau9" = structure(list("TxDb" = ifelse(is.null(TxDb), "TxDb.Btaurus.UCSC.bosTau9.refGene", TxDb),
                          "OrgDb" = "org.Bt.eg.db", gene.id.column = "ENTREZID", display.column = "SYMBOL",
                          "BSgenome" = "BSgenome.Btaurus.UCSC.bosTau9"), class = "bb_assembly"),
         "canFam3" = structure(list("TxDb" = ifelse(is.null(TxDb), "TxDb.Cfamiliaris.UCSC.canFam3.refGene", TxDb),
         ...
         "ce6" = structure(list("TxDb" = ifelse(is.null(TxDb), "TxDb.Celegans.UCSC.ce6.ensGene", TxDb),
                      "OrgDb" = "org.Ce.eg.db", gene.id.column = "GENEID", display.column = "GENEID",
                      "BSgenome" = "BSgenome.Celegans.UCSC.ce6"), class = "bb_assembly"),
         "ce11" = structure(list("TxDb" = ifelse(is.null(TxDb), "TxDb.Celegans.UCSC.ce11.refGene", TxDb),  # TxDb.Celegans.UCSC.ce11.ensGene also available
                       "OrgDb" = "org.Ce.eg.db", gene.id.column = "ENTREZID", display.column = "SYMBOL",
                       "BSgenome" = "BSgenome.Celegans.UCSC.ce11"), class = "bb_assembly"),
         "danRer10" = structure(list("TxDb" = ifelse(is.null(TxDb), "TxDb.Drerio.UCSC.danRer10.refGene", TxDb),
                           "OrgDb" = "org.Dr.eg.db", gene.id.column = "ENTREZID", display.column = "SYMBOL",
                           "BSgenome" = "BSgenome.Drerio.UCSC.danRer10"), class = "bb_assembly"),
         "danRer11" = structure(list("TxDb" = ifelse(is.null(TxDb), "TxDb.Drerio.UCSC.danRer11.refGene", TxDb),
                           "OrgDb" = "org.Dr.eg.db", gene.id.column = "ENTREZID", display.column = "SYMBOL",
                           "BSgenome" = "BSgenome.Drerio.UCSC.danRer11"), class = "bb_assembly"),
         "dm3" = structure(list("TxDb" = ifelse(is.null(TxDb), "TxDb.Dmelanogaster.UCSC.dm3.ensGene", TxDb),
         ...
         "dm6" = structure(list("TxDb" = ifelse(is.null(TxDb), "TxDb.Dmelanogaster.UCSC.dm6.ensGene", TxDb),
                      "OrgDb" = "org.Dm.eg.db", gene.id.column = "ENSEMBL", display.column = "SYMBOL",
                      "BSgenome" = "BSgenome.Dmelanogaster.UCSC.dm6"), class = "bb_assembly"),
         "galGal4" = structure(list("TxDb" = ifelse(is.null(TxDb), "TxDb.Ggallus.UCSC.galGal4.refGene", TxDb),
                          "OrgDb" = "org.Gg.eg.db", gene.id.column = "ENTREZID", display.column = "SYMBOL",
                          "BSgenome" = "BSgenome.Ggallus.UCSC.galGal4"), class = "bb_assembly"),
         "galGal5" = structure(list("TxDb" = ifelse(is.null(TxDb), "TxDb.Ggallus.UCSC.galGal5.refGene", TxDb),
                          "OrgDb" = "org.Gg.eg.db", gene.id.column = "ENTREZID", display.column = "SYMBOL",
                          "BSgenome" = "BSgenome.Ggallus.UCSC.galGal5"), class = "bb_assembly"),
         "galGal6" = structure(list("TxDb" = ifelse(is.null(TxDb), "TxDb.Ggallus.UCSC.galGal6.refGene", TxDb),
                          "OrgDb" = "org.Gg.eg.db", gene.id.column = "ENTREZID", display.column = "SYMBOL",
                          "BSgenome" = "BSgenome.Ggallus.UCSC.galGal6"), class = "bb_assembly"),
         "hg18" = structure(list("TxDb" = ifelse(is.null(TxDb), "TxDb.Hsapiens.UCSC.hg18.knownGene", TxDb),
                       "OrgDb" = "org.Hs.eg.db", gene.id.column = "ENTREZID", display.column = "SYMBOL",
                       "BSgenome" = "BSgenome.Hsapiens.UCSC.hg18"), class = "bb_assembly"),
         "hg19" = structure(list("TxDb" = ifelse(is.null(TxDb), "TxDb.Hsapiens.UCSC.hg19.knownGene", TxDb),
                       "OrgDb" = "org.Hs.eg.db", gene.id.column = "ENTREZID", display.column = "SYMBOL",
                       "BSgenome" = "BSgenome.Hsapiens.UCSC.hg19"), class = "bb_assembly"),
         "hg38" = structure(list("TxDb" = ifelse(is.null(TxDb), "TxDb.Hsapiens.UCSC.hg38.knownGene", TxDb),
                       "OrgDb" = "org.Hs.eg.db", gene.id.column = "ENTREZID", display.column = "SYMBOL",
                       "BSgenome" = "BSgenome.Hsapiens.UCSC.hg38"), class = "bb_assembly"),
         "mm9" = structure(list("TxDb" = ifelse(is.null(TxDb), "TxDb.Mmusculus.UCSC.mm9.knownGene", TxDb),
                      "OrgDb" = "org.Mm.eg.db", gene.id.column = "ENTREZID", display.column = "SYMBOL",
                      "BSgenome" = "BSgenome.Mmusculus.UCSC.mm9"), class = "bb_assembly"),
         "mm10" = structure(list("TxDb" = ifelse(is.null(TxDb), "TxDb.Mmusculus.UCSC.mm10.knownGene", TxDb),
                       "OrgDb" = "org.Mm.eg.db", gene.id.column = "ENTREZID", display.column = "SYMBOL",
                       "BSgenome" = "BSgenome.Mmusculus.UCSC.mm10"), class = "bb_assembly"),
         "rheMac3" = structure(list("TxDb" = ifelse(is.null(TxDb), "TxDb.Mmulatta.UCSC.rheMac3.refGene", TxDb),
         ...
         "rheMac8" = structure(list("TxDb" = ifelse(is.null(TxDb), "TxDb.Mmulatta.UCSC.rheMac8.refGene", TxDb),
                          "OrgDb" = "org.Mmu.eg.db", gene.id.column = "ENTREZID", display.column = "SYMBOL",
                          "BSgenome" = "BSgenome.Mmulatta.UCSC.rheMac8"), class = "bb_assembly"),
         "rheMac10" = structure(list("TxDb" = ifelse(is.null(TxDb), "TxDb.Mmulatta.UCSC.rheMac10.refGene", TxDb),
                           "OrgDb" = "org.Mmu.eg.db", gene.id.column = "ENTREZID", display.column = "SYMBOL",
                           "BSgenome" = "BSgenome.Mmulatta.UCSC.rheMac10"), class = "bb_assembly"),
         "panTro5" = structure(list("TxDb" = ifelse(is.null(TxDb), "TxDb.Ptroglodytes.UCSC.panTro5.refGene", TxDb),
         ...
         "panTro6" = structure(list("TxDb" = ifelse(is.null(TxDb), "TxDb.Ptroglodytes.UCSC.panTro6.refGene", TxDb),
                          "OrgDb" = "org.Pt.eg.db", gene.id.column = "ENTREZID", display.column = "SYMBOL",
                          "BSgenome" = "BSgenome.Ptroglodytes.UCSC.panTro6"), class = "bb_assembly"),
         "rn4" = structure(list("TxDb" = ifelse(is.null(TxDb), "TxDb.Rnorvegicus.UCSC.rn4.ensGene", TxDb),
                      "OrgDb" = "org.Rn.eg.db", gene.id.column = "ENSEMBL", display.column = "SYMBOL",
                      "BSgenome" = "BSgenome.Rnorvegicus.UCSC.rn4"), class = "bb_assembly"),
         "rn5" = structure(list("TxDb" = ifelse(is.null(TxDb), "TxDb.Rnorvegicus.UCSC.rn5.refGene", TxDb),
                      "OrgDb" = "org.Rn.eg.db", gene.id.column = "ENTREZID", display.column = "SYMBOL",
                      "BSgenome" = "BSgenome.Rnorvegicus.UCSC.rn5"), class = "bb_assembly"),
         "rn6" = structure(list("TxDb" = ifelse(is.null(TxDb), "TxDb.Rnorvegicus.UCSC.rn6.refGene", TxDb),
                      "OrgDb" = "org.Rn.eg.db", gene.id.column = "ENTREZID", display.column = "SYMBOL",
                      "BSgenome" = "BSgenome.Rnorvegicus.UCSC.rn6"), class = "bb_assembly"),
         "sacCer2" = structure(list("TxDb" = ifelse(is.null(TxDb), "TxDb.Scerevisiae.UCSC.sacCer2.sgdGene", TxDb),
         ...
         "sacCer3" = structure(list("TxDb" = ifelse(is.null(TxDb), "TxDb.Scerevisiae.UCSC.sacCer3.sgdGene", TxDb),
                          "OrgDb" = "org.Sc.sgd.db", gene.id.column = "ORF", display.column = "GENENAME",
                          "BSgenome" = "BSgenome.Scerevisiae.UCSC.sacCer3"), class = "bb_assembly"),
         "susScr3" = structure(list("TxDb" = ifelse(is.null(TxDb), "TxDb.Sscrofa.UCSC.susScr3.refGene", TxDb),
                          "OrgDb" = "org.Ss.eg.db", gene.id.column = "ENTREZID", display.column = "SYMBOL",
                          "BSgenome" = "BSgenome.Sscrofa.UCSC.susScr3"), class = "bb_assembly"),
         "susScr11" = structure(list("TxDb" = ifelse(is.null(TxDb), "TxDb.Sscrofa.UCSC.susScr11.refGene", TxDb),
                           "OrgDb" = "org.Ss.eg.db", gene.id.column = "ENTREZID", display.column = "SYMBOL",
