...
vaccines_NYpie <- ggplot(bb_VaccinesNYFL[bb_VaccinesNYFL$state == "new york",], 
  ...
  theme_void() +
  scale_fill_manual(values = c("light grey", "#85a9d5","#3a6dab")) +
  ...
  annotate(geom = "text",
           x = c(1.8, 1.9, 2),
           y = c(2.1e7, 1.1e7, 2e6),
           label = c("None", "One", paste("Two", "Doses", sep = "\n")),
           size = 2.25) +
  theme(legend.position = "none",
        plot.title = element_text(hjust = 0.5, vjust = -3.5, size = 13)) +
  labs(title = "New York")
...
vaccines_FLpie <- ggplot(bb_VaccinesNYFL[bb_VaccinesNYFL$state == "florida",], 
  ...
  scale_fill_manual(values = c("light grey", "#85a9d5","#3a6dab")) +
  theme_void() +
  coord_polar(theta = "y", start = -3.5*pi/8) +
  geom_text(aes(x = 1.1, label=paste0(percent, "%")),
            color = c("white", "white", "black"),
            size = 2.5,
            position = position_stack(vjust = 0.5)) +
...
```{r gg_plot05, eval=TRUE,echo=TRUE,message=FALSE,fig.width=12, fig.height=4.5}
bb_pageCreate(width = 10, height = 3.5, default.units = "inches")
...
bb_plotGG(plot = vaccines_NYpie,
          x = 6.5, y = -0.1,
          width = 1.5, height = 1.5, just = c("left", "top"))
bb_plotGG(plot = vaccines_FLpie,
          x = 6.5, y = 1.8,
          width = 1.5, height = 1.5, just = c("left", "top"))
```

```{r gg_plot06, eval=TRUE, echo=FALSE, message=FALSE,fig.width=12,fig.height=4.5}
bb_pageCreate(width = 10, height = 3.5, default.units = "inches")
...
```{r gg_plot07, eval=TRUE, echo=FALSE, message=FALSE,fig.width=12,fig.height=4.5}
bb_pageCreate(width = 10, height = 3.5, default.units = "inches",
              showGuides = FALSE, xgrid = 0, ygrid = 0)
