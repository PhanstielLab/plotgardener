...
```{r ideogram_01, eval=TRUE, echo=TRUE, message=FALSE, fig.height=5.25, fig.width=10}
## Load cytoband data
...
bb_pageCreate(width = 8, height = 4.25, default.units = "inches",
              showGuides = FALSE, xgrid = 0, ygrid = 0)
xCoord <- 0.15
for (chr in c(paste0("chr", seq(1, 22)), "chrX")){
