...
**`BentoBox` was developed to give users unparalleled control in plotting and**
...
measurement. This system makes the `BentoBox` plotting process intuitive 
...
bbPageCreate(width = 3, height = 3, default.units = "inches")
bbPlotSegments(x0 = 0.5, y0 = 0, x1 = 0.5, y1 = 0.5, 
                arrow = arrow(angle = 30, 
                            length = unit(0.1, "inches"), 
                            ends = "last", type = "closed"), 
                fill = "black")
bbPlotSegments(x0 = 0, y0 = 0.5, x1 = 0.5, y1 = 0.5, 
                arrow = arrow(angle = 30, 
                            length = unit(0.1, "inches"), 
                            ends = "last", type = "closed"),
                fill = "black")
...
bbPlotSegments(x0 = 0, y0 = 0.5, x1 = 0.5, y1 = 0.5, 
                arrow = arrow(angle = 30, 
                            ...
                            ends = "last", type = "closed"), 
                fill = "black")
bbPlotSegments(x0 = 0.5, y0 = 0.5, x1 = 2.5, y1 = 0.5, fill = "black", 
                arrow = arrow(angle = 30, 
                            length = unit(0.1, "inches"), 
                            ends = "both", type = "closed"))
bbPlotSegments(x0 = 0.5, y0 = 0.5, x1 = 0.5, y1 = 1.5, fill = "black", 
                arrow = arrow(angle = 30, 
                            length = unit(0.1, "inches"), 
                            ends = "both", type = "closed"))
...
## Create BentoBox page
bbPageCreate(width = 3, height = 2, default.units = "inches")

## Define genomic region with `bbParams`
genomicRegion <- bbParams(chrom = "chr8", 
...
## Create BentoBox page
bbPageCreate(width = 3, height = 4, default.units = "inches")
...
party graphic design software and cannot be easily replicated. `BentoBox` 
...
bbPageCreate(width = 7, height = 3.5, default.units = "inches")

## Define genomic region with `bbParams`
params <- bbParams(chrom = "chr21", 
...
`BentoBox` achieves its functionality through `grid` graphics `viewports`, 
or defined graphical regions. A `BentoBox` page is defined by one large 
